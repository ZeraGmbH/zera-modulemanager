...
private slots:
    ...
    void invalidSessionEmptyEntityComponents();
    void UndefinedContentSetEmptyAvailableContentSets();
    void EmptyContentSetsEmptyAvailableContentSets();
    void validContentSetsValidAvailableContentSets();
};
